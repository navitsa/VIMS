...
//getTest lanes according to centers
	...
	/*
	 * public List<TestLane> searchlanestoCombo(String center) { return
	 * testlaneRepo.searchlanes(center); }
	 */
...
//    
	...
	public void updateVehicleMaster(String engineNo, String chassisNo, String mYear, String rYear, String engineC,
			String noOfWheel, String emisNorms, String modelID, String fuelID, String vehicleNo) {
		masterRepo.updateVehicleMaster(engineNo, chassisNo, mYear, rYear, engineC, noOfWheel, emisNorms, modelID,
				fuelID, vehicleNo);
