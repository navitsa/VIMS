			...
			<ul class="nav nav-primary">
				...
				<li class="nav-item" id="maintenance" hidden="true"><a
					...
					<div class="nav-section collapse" id="eMaintenance">
						...
						<a class="collapse-item fontst-sb-it" href="calibrationCalendar"
							id="calibrationCalendar" hidden="true">Calibration Calendar</a>
						<a class="collapse-item fontst-sb-it" href="equipmentsCalibration"
