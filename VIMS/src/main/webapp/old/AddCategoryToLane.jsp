...
<html>
<head>
	<title>Add Category To Lane</title>
	<!-- head -->
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<h1 class="h3 mb-4 text-gray-800">Add Category To Lane</h1>
					<div class="row">
						<div class="container">
							<div
										...
										<div class="card-body">
											<div class="row no-gutters align-items-center">
												...
												<c:if test="${success ==1}">
													...
													<form:form action="savelaneTypeCategory"
														modelAttribute="laneTypeCategory" method="POST">
														<div class="row">
											...
											<form:select class="form-control"
												path="categoryId" required="Required">
...
<!-- 															<th></th> -->
													...
													<tbody id="myTable">
														<c:forEach items="${laneTypeCategoryList}" var="lane">
															<tr>
																<td><div>${lane.id}</div></td>
																<td><div>${lane.laneId.lane}</div></td> 
																<td><div>${lane.categoryId.categoryType}</div></td>
