                    ...
                    <div class="card border-0 mt-5 flex-fill d-none" id="event">
                        ...
                        <div class="card-body px-1 py-3">
                            <div class="text-center">
                              ...
                              <div class="input-group events-input mb-3 col-9 mx-auto mt-2">
                              <label>Calender Id: </label>
                                <input type="text" class="form-control" placeholder="empty" id="Calander_ID" readonly="true">
                            </div> 
                            
                           
                                <div class="input-group events-input mb-3 col-9 mx-auto mt-2">
                                 <label>Company Id</label>
                                <input type="text" class="form-control" placeholder="empty" id="Company_ID" readonly="true">
                            </div> 
                            
                          
                              <div class="input-group events-input mb-3 col-9 mx-auto mt-2">
                                <label>Description</label>
                                <input type="text" class="form-control" placeholder="empty" id="Description" readonly="true">
                            </div> 
                            
                            
                              <div class="input-group events-input mb-3 col-9 mx-auto mt-2">
                              <label>Status</label>
                                <input type="text" class="form-control" placeholder="empty" id="Status" readonly="true">
                            </div> 
                            
                           
                             <div class="input-group events-input mb-3 col-9 mx-auto mt-2">
                              <label>Type</label>
                                <input type="text" class="form-control" placeholder="empty" id="Types" readonly="true" >
                            </div>  
...
*/
        ...
        $(document).on('click', '.showEvent', function(){
            ...
            let todaysDate = year +'-'+ (months[month]) +'-'+ $(this).text();
    		...
    		success : function(data) {
               ...
               document.getElementById("Calander_ID").value = data.calander_ID;             
