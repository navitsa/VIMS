					...
					<div class="page-header">
							...
							<div class="col-xl-9 col-md-6mb-4 ">
								<div class="card border-left-primary shadow h-100 py-2">
									<div class="card-body">
										...
										<div class="row no-gutters align-items-center">
											<div class="col mr-2">
												...
												<form:form action="savevmodel" method="post" modelAttribute="vehicleModelForm"
													...
													<div class="form-group row">
														<div class="col-lg-4">
																...
																<form:select class="custom-select"
																	id="vehicleMakeID" path="vehicleMakeID.vehicleMakeID"
														...
														<div class="col-lg-4">
															<div id="demo"></div>
															<c:if test="${vehicleModelForm.vehicleMakeID.makeLogo != null}">
																<img src="data:image/jpg;base64,${vMakeLogo}" class="img-thumbnail" width="80" height="80">
															</c:if>
															<img src="" id="mydemo" class="img-thumbnail">
														</div>
														<div class="col-lg-4">
															<label for="vehicleModelID">Vehicle Model ID</label>
															<form:input class="form-control form-control-sm" path="vehicleModelID" readonly="true" style="width:80px" />
														</div>
													</div>
													<div class="form-group row">
														<div class="col-lg-4">
															...
															<form:select class="custom-select"
																id="vehicleClassID" path="vehicleClass.vehicleClassID"
																required="true" onchange="getModelData();">
													...
													<div class="row">
														...
														<div class="col-sm-5">
															<div class="col-sm-60 mb-1 mb-sm-3">
																...
																<form:input type="file" class="file" id="modelLogo" path="modelLogo" />
																<div class="input-group">
																	<input type="text"
																		class="form-control"
																		disabled placeholder="choose image..." id="file">
									...
									<table
												class="table table-bordered table-hover table-wrapper-scroll-y my-custom-scrollbar"
												cellspacing="3" id="dataTable" width="100%" cellspacing="3" id="vmodelTable">
												<thead>
													<tr>
														<th>Model ID</th>
														<th>Model</th>
