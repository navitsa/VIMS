	...
	<div class="wrapper">
		...
		<div class="main-panel">
			...
			<div class="col-xl-5 col-md-6mb-4 ">
												...
												class="uploadFile img" value="Upload Photo" style="width: 0px;height: 0px;overflow: hidden;"  accept="image/*" 
												id="user_Img" name="user_Img"></label>
													...
													<div class="border border-primary ">
														...
														<div class="col-sm-6 mb-1 mb-sm-3">
															...
															<form:input class="form-control form-control-user" type="hidden"
																id="empId" path="empId" />
														</div>
