					...
					<div class="page-inner py-4">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							...
							<div class="ml-md-auto py-2 py-md-4">
								<a href="visualChecklist" class="btn btn-white btn-border btn-round mr-2">Visual Inspection</a>
								<a href="testValueFile" class="btn btn-white btn-border btn-round mr-2">Test Results</a>
