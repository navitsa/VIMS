...
<!-- 						</div> -->
   	...
   	<!-- Content Row -->
   	 <form:form action="saveVMasterk" method="post" modelAttribute="saveVMaster" enctype="multipart/form-data" id="form1" >
	<div class="row">
						...
						<div class="form-group row">						
							...
							<div class="col-sm-6">	
								<div class="row">
									...
									<div class="col-sm-5">						             			             		
					             		<form:input class="form-control fontst" path="engineCapacity" id="engineCapacity" required="true"/>
			...
			<div class="card shadow mb-4">
				...
				<div class="card-body">
					...
					<div class="row">
						...
						<div class="col-sm-5">
							<form:input class="form-control"  path="ownerID" id="ownerId" hidden="true"  value="${veOwner.ownerID}"/>	
					...
					<div class="row">
						...
						<div class="col-lg-4">
							<form:select path="title" id="title" class="custom-select custom-select-sm" 
							required="true">										
						...
						<div class="col-sm-8">
			             <form:input  class="form-control fontst" path="ownerName"  value="${veOwner.ownerName}" required="true"/>	
						</div>
					</div>	
					<div class="row">
						<div class="col-sm-2">
					...
					<div class=" row">
						<div class="col-sm-12">
							<form:input  class="form-control fontst" path="postalBox" value="${veOwner.postalBox}" required="true"/>
						</div>
					</div>
					<div class="row">
						<div class="col-sm-2">
					...
					<div class=" row">
						<div class="col-sm-12">
							<form:input  class="form-control fontst" path="add01" value="${veOwner.add01}" required="true"/>
						</div>
					</div>	
					...
					<div class=" row">
						<div class="col-sm-12">
							 <form:input  class="form-control fontst" path="city" value="${veOwner.city}" required="true" />
						</div>
					</div>	
					...
					<div class=" row">
						<div class="col-sm-12">
				             <form:select  path="stateid.stateid"  value="${veOwner.stateid.stateid}" class="custom-select fontst"  required="true">
					...
					<div class=" row">
						...
						<div class="col-sm-3"> 
							 <form:input  class="form-control fontst" path="" value='<%=session.getAttribute("countryCode")%>' required="true" readonly="true"/>
						</div>
						<div class="col-sm-8"> 
							 <form:input  class="form-control fontst" path="contactNo" value="${veOwner.contactNo}" required="true"/>
						</div>
					</div>	
					...
					<div class="row">
						...
						<div class="col-sm-11">
							 <form:input  class="form-control fontst" path="email" value="${veOwner.email}"/>
						</div>
					</div>	
									...
									<tbody id="myTable">
										...
										<c:forEach items="${pre_owners}" var="preOwners">
											<c:if test = "${preOwners.status=='previousOwner'}">
												<tr>    		
									    			<td><div style="color: #000099; font-family: Arial, Helvetica, sans-serif; font-size: 12px">${preOwners.ownerName}</div></td>
									    		</tr>		
									    	</c:if>										
										</c:forEach>
									</tbody>
