						...
						<div class="form-group row">
							...
							<div class="form-group row">
										...
										<label class="l-fontst">Amount</label>
											<input class="form-control fontst" type="number" name="amount" 
											onchange=""
											id="amount"
											/>	
										</div>
...
<!-- 							</div> -->
							...
							<div class="form-group row">
									...
									<div class="col-sm-12">
									<input type="button" class="add-row btn btn-info" value="Add Entery >>" onclick="addEqumentToTable();">
