				...
				<div class="page-inner">
					<div class="page-header">
						...
						<ul class="breadcrumbs">
							...
							<li class="nav-item"><a href="#">Lane Registration Types</a>
							</li>
										...
										<div class="col mr-2">
											...
											<form:form id="typesForm" action="saveVRegTypes"
												...
												<div class="form-group row">
													<div class="col-lg-3">
														<label for="vRegType">Entry Type <span
															class="required text-danger">*</span></label>
													</div>
													<div class="col-lg-6">
														<form:input type="text"
															class="form-control form-control-sm" id="vRegType"
															path="vRegType" />
												...
												<div class="form-group row">
													<div class="col-lg-3">
														<label for="vTestFeePre">Test Fee % <span
															class="required text-danger">*</span></label>
													</div>
													<div class="col-lg-3">
														<form:input type="number"
															class="form-control form-control-sm" id="vTestFeePre"
															path="vTestFeePre" required="true" />
														<form:errors path="vTestFeePre"
												...
												<div class="form-group row">
													<div class="col-sm-3">
														<label>Validity for Repeat Test</label>
													</div>
													<div class="col-sm-3">
														<form:input type="number"
															class="form-control form-control-sm" id="vRT"
															path="vRT" />
													</div>
												</div>
												<div class="form-group row">
													...
													<div class="col-sm-3">
														<input type="radio" name="status" value="Active"
															checked="checked"> <label>Active</label> <input
															type="radio" name="status" value="Inactive"> <label>Inactive</label>
													</div>
												</div>
											...
											<div id="tablelan"
												class="scrollable  table-wrapper-scroll-y my-custom-scrollbar">
												...
												<table class="table table-bordered table-hover" width="100%"
													...
													<thead>
														<tr>
															...
															<th>Entry Type</th>
															<th>Test Fee %</th>
																<th>Validity for Repeat Test</th>
															<th>Remark</th>
															<th>Status</th>
															<th></th>
														</tr>
													...
													<tbody id="myTable">
														<c:forEach items="${vehicleRegisterTypelist}" var="vtypes">
															<tr>
																
																<td><div>${vtypes.vRegType}</div></td>
																<td><div>${vtypes.vTestFeePre}</div></td>
																<td><div>${vtypes.vRT}</div></td>
																<td><div>${vtypes.remark}</div></td>
																<td><div>${vtypes.status}</div></td>
																<td><a href="editVRegType?id=${vtypes.vRegTypeID}"><i
