...
<body onload="checkStatusofDropdowns();">
						...
						<div class="col-xl-12 col-md-6mb-4">
							<div class="card border-left-primary shadow h-100 py-2">
								<div class="card-body">
									...
									<form:form modelAttribute="equipmentsIssue" method="POST"
										enctype="multipart/form-data" id="eqissue">
										<div class=" row">
											<div class="col-sm-7">
												...
												<div class="form-group row">
													...
													<div class="col-sm-4">
														...
														<div class="btn-group btn-group-toggle"
															data-toggle="buttons" style="border-radius: 60px;">
															<label class="btn btn-outline-info btn-sm active">
																<input id="status" name="laneStatus"
																onfocus="geGlaccountByPrimaryAccount(this.value);"
																type="radio" value="Working">Lane is Active
															</label> <label class="btn btn-outline-secondary btn-sm">
																<input id="status" name="laneStatus"
																onfocus="geGlaccountByPrimaryAccount(this.value);"
																type="radio" value="Temporally close">Temporally
																close the lane
															</label>
												...
												<div class="form-group row">
													...
													<div class="col-sm-3">
														<label>Equipment Type</label> <select class="form-control"
															onchange="getAllEquipmenteByEquipmenteType();"
															id="eqtype">
													...
													<div class="col-sm-4">
														...
														<form:select class="form-control"
															path="equipmentID.equipmentID" id="eqid"
															onchange="setDate();">
															<form:option value="000">--SELECT--</form:option>
														</form:select>
													</div>
						...
						<form:option value="High">High</form:option>
													...
													<div class="col-sm-4">
														...
														<div class="btn-group btn-group-toggle"
															data-toggle="buttons" style="border-radius: 60px;">
															<label class="btn btn-outline-info btn-sm active">
																<input id="status" name="eqIsWorking"
																onfocus="geGlaccountByPrimaryAccount(this.value);"
																type="radio" value="Working">Working
															</label> <label class="btn btn-outline-secondary btn-sm">
																<input id="status" name="eqIsWorking"
																onfocus="geGlaccountByPrimaryAccount(this.value);"
																type="radio" value="Not Working">Not Working
															</label>
												...
												<div class="form-group row">
													<h1
														style="color: #ff0516; font-family: Arial, Helvetica, sans-serif;"
														id="laneSta"></h1>
											...
											<div class="col-sm-5">
												<h2
													style="color: #ff0516; font-family: Arial, Helvetica, sans-serif;">Manage
													Appointment</h2>
												<div
													class="row table-striped table-bordered table-sm table-wrapper-scroll-y my-custom-scrollbar">
	...
	<script type="text/javascript">
		function currentTime() {
			...
			document.getElementById("eq").innerHTML = n;
		}
		...
		function getLaneStatus() {
			...
			if (laneStatus == "Temporarily close" && $('#tldid').val() != "000") {
				...
				document.getElementById("laneSta").innerHTML = tldid
						+ " is Temporally Close";
			} else {
						...
						success : function(data) {
							...
							for (var i = 0; i < data.length; i++) {
								...
								selected_option = "<div class='row'style=''>"
										...
										+ "<div class='row'>"
										+ "<div class='col-sm-12'>"
										+ "<div style='color: #ff0516; font-family: Arial, Helvetica, sans-serif; font-size: 14px'>"
										+ data[i].vehicle_id.vehicleID
										+ "</div>"
										+ "</div>"
										+ "</div>"
										+ "<div class='row'>"
										+ "<div class='col-sm-12'>"
										+ "<div style='color: #000000; font-family: Arial, Helvetica, sans-serif; font-size: 13px'>"
										+ data[i].appointmentDate + " "
										+ data[i].appointmentTime + "</div>"
										+ "</div>" + "</div>" +
			...
			$.ajax({
				...
				success : function(data) {
					...
					if (data == "0") {
						...
						swal("Successfully Issued Ticket!", "Ticket No : "
								+ data, {
							icon : "success",
							buttons : {
								confirm : {
