					...
					<div class="form-group row">						
							<div class="col-sm-6">
								<div class="row">
									...
									<div class="col-sm-8">						             			             		
										<label for="manufactureYear" class="2-fontst">${VehicleRegistration.testCategory.categoryType }</label>
									</div>			
								</div>
							...
							<div class="col-sm-6">	
								<div class="row">
									...
									<div class="col-sm-6">						             			             		
										<label for="manufactureYear" class="2-fontst">${VehicleRegistration.vtype.vRegType }</label>
									</div>
					...
					<div class="form-group row">						
							<div class="col-sm-6">
								<div class="row">
									...
									<div class="col-sm-8">						             			             													
										<label for="manufactureYear" class="2-fontst">${VehicleRegistration.testLaneHeadId.laneName }</label>										             		
									</div>			
								</div>
							...
							<div class="col-sm-6">	
								<div class="row">
									...
									<div class="col-sm-6">						             			             		
                                        <label for="manufactureYear" class="2-fontst">${VehicleRegistration.user.userName }</label>
									</div>
