					...
					<div class="page-inner py-3">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div class="col-xl-2 col-lg-2">
								 <h2 class="text-white pb-2 fw-bold">Bank Account</h2>
							</div>
							<div class="col-xl-2 col-lg-2">
...
<div class="col-xl-9 col-md-6mb-4 ">
									<div class="card border-left-primary shadow h-100 py-2">
										<div class="card-body">
											<div class="row no-gutters align-items-center">
												...
												<option value=""> --SELECT--</option>
													<c:forEach items="${bankNameList}" var="t">
														<option value="${t.bankid}">${t.bankName}</option>
													</c:forEach>
											</select>
												...
												id="branchID" path="branchID.branchID">
												<option value=""> --SELECT--</option>
													<c:forEach items="${bankBranchList}" var="t">
														<form:option value="${t.branchID}">${t.branch}</form:option>
													</c:forEach>
											</form:select>
											...
											<form:select class="custom-select custom-select-mb"
												id="bankid" path="glAccNo.glAccNo">
												<option value=""> --SELECT--</option>
													<c:forEach items="${glaccountList}" var="t">
														<form:option value="${t.glAccNo}">${t.glAccountName}</form:option>
													</c:forEach>
											</form:select>
		...
		<col width="0">-->
														...
														<tbody id="myTable">
															<c:forEach items="${allaccountetails}"
																var="allBankDetails">
																<tr>
																	<td><div>${allBankDetails.bankAccountNo}</div></td>
																	<td><div>${allBankDetails.accountName}</div></td>
																	<td><div>${allBankDetails.branchID.branch}</div></td>
																	<td><div>${allBankDetails.glAccNo.glAccNo}-${allBankDetails.glAccNo.glAccountName}</div></td>
