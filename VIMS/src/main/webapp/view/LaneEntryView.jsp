...
<body onload="checkStatusofDropdowns();">
		...
		<div class="main-panel">
			<div class="content">
					...
					<div class="page-inner py-3">
						<div
							...
							<div class="col-xl-2 col-lg-2">
								<img src="data:image/jpg;base64,${imgVimg}" class="capCam"
									id="results"
							...
							<div class="ml-md-2 py-2 py-md-2">
				...
				<div class="page-inner mt--5">
					...
					<form:form modelAttribute="VehicleRegistration" method="POST"
						id="formVehicleRegistration">
						<!-- Card -->
						<!-- Area Chart -->
								...
								<div class="card shadow mb-4">
									...
									<div class="card-body">
										<div class="row">
											...
											<div class="col-sm-4">
												<select id="payVehicleNo" class="custom-select fontst"
													onchange="setPayVehicleNo(this.value);">
											...
											<div class="col-sm-3">
												<button type="button" class="btn btn-primary btn-block"
													data-toggle="modal" data-target="#capturePlateModal">Capture
													License Plate</button>
											</div>
											<div class="col-sm-3">
												<button type="button" class="btn btn-primary btn-block"
													data-toggle="modal" data-target="#manualCapPlateModal"
													onClick='getMCaptureImage();'>Manual Capture</button>
											</div>
											...
											<div class="col-sm-6">
												<div class="row">
													...
													<div class="col-sm-8">
														...
														<input class="form-control fontst" id="vregID"
															type="hidden" value="${VehicleRegistration.vregID}"
															onchange="customerDate();" required="Required" />
										...
										<div class="form-group row">
											<div class="col-sm-6">
												<div class="row">
													<div class="col-sm-4">
														<label for="manufactureYear" class="l-fontst">Test
															Category</label>
													</div>
													<div class="col-sm-8">
										...
										<div class="row">
											...
											<div class="col-sm-3 ">
												...
												<div id="overlay" style="display: none;">
													<div id="loading-effect">
														<img alt="" src="resources/img/96x96.gif">
													</div>
											...
											<div class="col-sm-5 justify-content-end">
												...
												<button type="button" style="display: none;"
													...
													onclick="checkCondition();" id="proceedLanBtn">Proceed
													to Lane Entry in Lane</button>

												<div class="spinner-grow" role="status" id="moreLoder"
													style="display: none;">
							...
							<div class="col-xl-4 col-lg-5">
								<div class="card shadow mb-4">
									...
									<div
										...
										<img src="resources/img/icon/perviousVehicleicon.png"
											class="iconstyle" />
						...
						<div class="modal-dialog">
							...
							<div class="modal-content">
								<div class="modal-header">
									...
									<div class="col-sm-5">
										<input class="form-control textred" name="vehNO"
											value="${vehNo}" id="vehNO" placeholder="Licence Plate NO..."
											readonly="true" />
									</div>
												...
												<div class="col-sm-5">
													<div class="form-group row">
														<div class="col-sm-12">
															...
															<input class="form-control form-control-sm" name="ocrrid"
																id="ocrrid" value="${ocid}" type="hidden" />
														</div>
													</div>
													<div class="row">
												...
												<div class="col-sm-6">
													...
													<div class="row">
														<div class="col-sm-12">
															...
															<div class="loader" id="moreLoder1"
													...
													<div class="row">
														<div class="col-mb-12 col-sm-12">
															<img src="resources/img/car-placeholder.jpg"
																class="capCam" id="results1" /> <input type="hidden"
																name="ImageData" id="ImageData" />
													...
													<div class="row">
														<div class="col-mb-12 col-sm-12">
															<input class="form-control fontst bgred" id="vehicleID"
																...
																oninput="checkVehicleNo(this.value)"
								...
								<div class="modal-footer">
									...
									<div class="col-sm-2 mb-sm-2">
										<button type="button" class="btn btn-success"
											data-dismiss="modal" onclick="saveOcrImage()"
											style="display: none;" id="veButt">Save</button>
									</div>
					...
					<div id="manualCapPlateModal" class="modal fade bd-example-modal"
						role="dialog" aria-labelledby="myExtraLargeModalLabel"
						aria-hidden="true">
						<div class="modal-dialog">
							...
							<div class="modal-content">
								<div class="modal-header">
									...
									<div class="col-sm-5">
										<input class="form-control textred" name="cocrrid"
											id="cocrrid" placeholder="Gate Entry ID ..." readonly="true" />
									</div>
											...
											<div class="row">
												...
												<div class="col-sm-6">
													...
													<div class="row">
														<div class="col-mb-12 col-sm-12">
															<img src="resources/img/car-placeholder.jpg"
																class="capCam" id="results5" /> <input name="ImageData5"
																id="ImageData5" type="hidden" />
								...
								<div class="modal-footer">
									...
									<div class="col-sm-2 mb-sm-2">
										<button type="button" class="btn btn-success"
											data-dismiss="modal" onclick="saveOcrMImage()" id="veButt">Save</button>
									</div>
									<div class="col-sm-3 mb-sm-3">
										<button type="button" class="btn btn-info"
											data-dismiss="modal">Close</button>
					...
					.ajax({
						...
						success : function(data) {
							if (data == "1") {
								...
								swal(
										"Oops...",
										"License Plate is not captured ! Please capture and continue",
										{
											icon : "error",
											buttons : {
												confirm : {
								...
								swal(
										"Oops...",
										"This vehicle already assigned to a lane !",
										{
											icon : "error",
											buttons : {
												confirm : {
								...
								swal(
										"Oops...",
										"Data Transfer Server not Found !",
										{
											icon : "error",
											buttons : {
												confirm : {
								...
								swal(
										"Oops...",
										"AVL Data Transfer Server not Found !",
										{
											icon : "error",
											buttons : {
												confirm : {
								...
								swal(
										"Oops...",
										"MAHA Data Transfer Server not Found !",
										{
											icon : "error",
											buttons : {
												confirm : {
								...
								swal(
										"Good job!",
										"This vehicle successfully assigned to the lane!",
										{
											icon : "success",
											buttons : {
												confirm : {
	...
	<script type="text/javascript">
			...
			$.ajax({
				...
				success : function(data) {
					...
					for (var i = 0; i < data.length; i++) {
						...
						selected_option = "<tr data-folder='ghjgh'><td>"
								+ data[i].number + "</td>"
								+ "<td style='display:none;'>"
								+ data[i].noimage + "</td>" + "</tr>";
		...
		tbody.onclick = function(e) {
			...
			document.getElementById('results1').src = "data:image/jpg;base64,"
					+ data[1];
			document.getElementById("ImageData").value = "data:image/jpg;base64,"
					+ data[1];
		};
		...
		function saveOcrImage() {
			...
			if (imagebase64 != "") {
				...
				var jsonfile = {
					json : JSON.stringify(imagebase64),
					id : y
				};
				$
						.ajax({
							...
							success : function(data) {
								...
								if (data == "1") {
									...
									swal(
											"Good job!",
											"License Plate Capturing is successfully !",
											{
												icon : "success",
												buttons : {
													confirm : {
			...
			$
					.ajax({
						...
						success : function(data) {
							...
							document.getElementById("results").src = "data:image/jpg;base64,"
									+ arrayBufferToBase64(data.ocrid.noimage);
					...
					.ajax({
						...
						success : function(data) {
							...
							for (var i = 0; i < data.length; i++) {
								//if(data[i].noimage==""){
								option = option
										+ "<option value='"+data[i].ocrid + "'>"
										+ data[i].ocrVid + "</option>";
								//}
							}
		...
		function getMCaptureImage(ocrid) {
			...
			document.getElementById("cocrrid").value = document
					.getElementById("ocrrid").value;
			...
			$
					.ajax({
						...
						success : function(data) {
							...
							//$("table tbody").append(markup);
							//	 			           	 }
							document.getElementById('results5').src = "data:image/jpg;base64,"
									+ data;
							document.getElementById("ImageData5").value = "data:image/jpg;base64,"
									+ data;
						...
						.ajax({
							...
							success : function(data) {
								...
								if (data == "1") {
									...
									swal(
											"Oops...",
											"Not captured ! Please capture and continue ..",
											{
												icon : "error",
												buttons : {
													confirm : {
