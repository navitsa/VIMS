...
<body>
	<div class="wrapper">
		...
		<div class="main-panel">
			...
			<form:form action="saveLaneHead" method="post" modelAttribute="saveLaneHead" id="formTestLane">

						<div class="form-group row">
							
						<form:input class="form-control fontst " path="centerID" value='<%=session.getAttribute("centerid")%>' onchange="setProgress();" hidden="true" id="icenterId" required="sd"/>
					<form:input class="form-control form-control-user" path="testLaneHeadId" placeholder="Enter ID" hidden="true" readonly="true" />
						...
						<div class="form-group row">
							...
							<div class="col-sm-6">
								<form:input class="form-control form-control-user fontst" path="laneName" placeholder="Enter Lane" />
							</div>	
						</div>						
						...
						<div class="form-group row">
							...
							<div class="col-sm-4">
								<form:input class="form-control form-control-user fontst" type="number"	path="laneCap" placeholder="Enter Lane capacity" min="1" max="99"/>
							</div>	
						</div>				
														...
														<tbody id="myTable">
															<c:forEach items="${allLaneHead}"
																...
																<tr>
																	...
																	<td><div><a class="btn btn-primary btn-sm" href="TestLaneDetails?id=${allLaneHead.testLaneHeadId}">Configure Lanes</a></div></td>
		...
		if(str == "") {
		    ...
		    success: function(data){
		    	...
		    	// var x = document.getElementById("makeImg");
			        ...
			        $('progress').attr({value:data,max:100});
		    },
		    error:function(){
