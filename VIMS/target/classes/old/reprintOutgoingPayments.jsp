...
<head>
<title>Outgoing Payments Reprint</title>
					...
					<div class="card shadow mb-4">
						<div class="card border-left-primary shadow h-100 py-2">
							<div class="card-header py-3">
								<h6 class="m-0 font-weight-bold text-primary">Outgoing Payments Reprint</h6>
							</div>
							<div class="card-body">
								<form:form action="PrivewOutgoingPayments"  method="POST">
									...
									<div class="form-group row">
										...
										<div class="col-sm-3">
											<label class="l-fontst">Incoming Receipt No</label>
												...
												id="voucherNo" name="voucherNo"  required onchange="getIncReceiptDetail(this.value);">
							...
							if(data!=""){
								...
								for (var i = 0; i < data.length; i++) {
									option = option
											...
											+ data[i].paymentVoucherNo + "</option>";
								}
