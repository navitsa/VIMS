				...
				<div class="page-inner">
					<div class="page-header">
						...
						<ul class="breadcrumbs">
							...
							<li class="nav-item"><a href="#">Country Setting</a></li>
							<li class="separator"><i class="flaticon-right-arrow"></i></li>
							<li class="nav-item"><a href="taxConfiguration">Tax
									Configuration</a></li>
											...
											<form:form action="taxConfigurationSave" method="POST"
												...
												<div class="form-group row">
													...
													<div class="col-lg-4">
														...
														<form:hidden class="form-control form-control-sm"
															path="countryCode" id="cCode"
												...
												<div class="form-group row">
													<div class="col-lg-2">
														...
														<label for="taxValue">Tax Value <span
															class="required text-danger">*</span></label> <input
															class="form-control" name="taxRaten" id="taxValue"
															value="${etaxRate}" />
													...
													<div class="col-lg-3">
														...
														<div class="custom-control custom-radio">
															<input type="radio" class="custom-control-input"
																...
																class="custom-control-label" for="rate">Rate (%)</label>
														</div>
														<div class="custom-control custom-radio">
															<input type="radio" class="custom-control-input"
												...
												<div class="form-group row">
													<div class="col-lg-4">
														...
														<form:select path="glAccNo.glAccNo"
															class="custom-select custom-select-sm" id="glAccNo1"
															required="true">
													...
													<div class="col-lg-3">
														...
														<label for="sequenceId">Sequence ID <span
															class="required text-danger">*</span></label>
														<form:select class="custom-select custom-select-sm"
															path="sequenceId" id="sequenceId" required="Required">
												...
												<tbody>
													<c:forEach items="${taxesList}" var="tax">
														<tr>
															...
															<td><div>${tax.glAccNo.glAccNo}
																	${tax.glAccNo.glAccountName}</div></td>
